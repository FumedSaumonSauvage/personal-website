...
// You can change this image path and text as needed
const IMAGE_URL = "/found_objects/kindle.png";
const CONTACT_TEXT = `If you found this Kindle, please contact Simon Hergott
Email: hergottsimon + @ + gmail.com
Phone: +33 6 52 05 09 twenty-one

Si vous avez trouvé ce Kindle, merci de contacter Simon Hergott
Email : hergottsimon + @ + gmail.com
Téléphone : +33 6 52 05 09 vingt-et-un

このKindleを見つけた方は、シモン・ヘルゴットまでご連絡ください
